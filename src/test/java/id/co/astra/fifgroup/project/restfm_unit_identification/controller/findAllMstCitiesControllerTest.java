...
//
//        when(findAllMstCitiesService.findAllMstCities()).thenReturn(new ResponseEntity(responseFiduciaObj, HttpStatus.OK));
//
//        ResultActions resultActions;
//        resultActions = mockMvc.perform(MockMvcRequestBuilders.get("/restfmui/v1/find-all-cities").contentType(MediaType.APPLICATION_JSON));
//
